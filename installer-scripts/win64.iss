...
#define MyAppExeName "coloredcoins-full-node.exe"
#define Bitcoin64 "bitcoin-0.14.1-win64-setup.exe"
...
OutputDir=..
OutputBaseFilename=coloredcoins-full-node-win64-setup
Compression=lzma
SolidCompression=yes
SourceDir=..\dist\coloredcoins-full-node-win32-ia32
...
Source: "..\..\dependencies\{#Litecoin64}"; DestDir: "{tmp}"; Flags: deleteafterinstall
...
Filename: "{tmp}\{#Litecoin64}"; Components: litecoin_core
